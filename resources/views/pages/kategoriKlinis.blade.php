<x-template title="kategori klinis">
            ...
            <tbody>
                @foreach ($kategoriClinises as $kategoriClinis)
                    <tr class="border-t border-gray-100 hover:bg-gray-50 transition-colors duration-150">
                        <td class="px-6 py-4 font-medium">{{ $kategoriClinis->idkategori_klinis }}</td>
                        <td class="px-6 py-4">{{ $kategoriClinis->nama_kategori_klinis }}</td>
