				...
				<div class="col-lg-8">
					<div class="card">
						<div class="card-body">
                            ...
                            <form action="{{ route('update-profil-perawat', ['id' => Auth::user()->iduser ]) }}" method="post">
                            @csrf
                            @method('PATCH')
							<div class="row mb-3 align-items-center">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" name="nama" data-field="nama" value="{{ $perawat_data->UserRshp->nama }}" requried>
								</div>
							</div>
							<div class="row mb-3 align-items-center">
								<div class="col-sm-3" style="height: fit-content">
								...
								<div class="col-sm-9 text-secondary">
									<input type="email" class="form-control" name="email" value="{{ $perawat_data->UserRshp->email }}" data-field="email" required>
								</div>
							</div>
							<div class="row mb-3 align-items-center">
								<div class="col-sm-3" style="height: fit-content">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" name="no_hp" data-field="nomor" value="{{ $perawat_data->no_hp }}" required>
								</div>
							</div>
							<div class="row mb-3 align-items-center">
								<div class="col-sm-3" style="height: fit-content">
									<h6 class="mb-0" id="field-title-pendidikan">Pendidikan</h6>
								</div>
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" name="pendidikan" data-field="pendidikan" value="{{ $perawat_data->pendidikan }}" required>
								</div>
							</div>
							<div class="row mb-3 align-items-center">
								<div class="col-sm-3" style="height: fit-content">
								...
								<div class="col-sm-9 text-secondary">
                                    <textarea class="form-control" name="alamat" rows="5" data-field="alamat" required>{{ $perawat_data->alamat }}</textarea>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-3"></div>
								<div class="col-sm-9 d-flex gap-2 text-secondary justify-content-end">
                                    <a href="{{ route('profile-perawat') }}" class="btn btn-secondary text-white">Cancel</a>
                                    <button type="reset" class="btn btn-info text-white" onclick="changeFormTitleStarred('nama', true);changeFormTitleStarred('email', true);changeFormTitleStarred('nomor', true);changeFormTitleStarred('pendidikan', true);changeFormTitleStarred('alamat', true);">Reset</button>
