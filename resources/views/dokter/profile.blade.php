                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-black">
                                    {{ $dokter_data->UserRshp->nama }} {{ $dokter_data->jenis_kelamin == 'L' ? '(Laki-laki)' : '(Perempuan)' }}
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">Bidang Dokter</h6>
                                </div>
                                <div class="col-sm-9 text-black">
                                    {{ $dokter_data->bidang_dokter }}
                                </div>
                            </div>
                            <hr>
                            <div class="row">
